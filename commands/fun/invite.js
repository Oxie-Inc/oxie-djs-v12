...
module.exports = {
    run: async message => {
        ...
        const bot = new MessageButton().setStyle('url').setLabel('Invite Bot').setURL('https://discord.com/api/oauth2/authorize?client_id=874299824508370944&permissions=8&scope=bot%20applications.commands');
